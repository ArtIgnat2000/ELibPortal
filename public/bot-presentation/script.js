...
function initSlideEyebrows() {
    slides.forEach((slide, index) => {
        let eyebrow = slide.querySelector('.title-eyebrow');
        ...
        if (!eyebrow) {
            ...
            eyebrow.className = 'title-eyebrow slide-eyebrow';
            slide.insertBefore(eyebrow, heading);
        }

        eyebrow.textContent = `${index + 1}`;
    });
}
